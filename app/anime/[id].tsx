...
const MovieDetails = () => {
  ...
  >
    ...
    <View style={{ position: 'relative' }}>
      ...
      />
      <LinearGradient
        colors={['transparent', 'rgba(10,10,15,0.2)', 'rgba(10,10,15,0.8)', '#0a0a0f']}
        style={{
          position: 'absolute',
          left: 0,
          right: 0,
      ...
      <View style={{ 
        ...
        <View style={{ 
          ...
          <View style={{ flex: 1, paddingTop: 10 }}>
            ...
            {/* Score and Rank with Vibrant Gradients */}
            <View style={{ 
              flexDirection: 'row',
              alignItems: 'center',
              gap: 12,
    ...
    <View style={{ paddingHorizontal: 20 }}>
      {/* Genres with Holographic Effect */}
      <View style={{ 
        flexDirection: 'row',
        flexWrap: 'wrap',
        gap: 10,
            ...
            <View key={index} style={{ marginBottom: 20 }}>
              ...
              <View style={{ gap: 10 }}>
                {relation.entry.map((entry, entryIndex) => (
                  <Link href={entry.url} key={entryIndex}>
                    <View style={{
                      backgroundColor: '#1e293b',
                      padding: 16,
                      borderRadius: 16,
        ...
        <View style={{
          ...
          <View style={{
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
              ...
              <Text style={{ color: '#94a3b8', fontSize: 16, fontWeight: '500' }}>Members</Text>
            </View>
            <Text style={{
              color: '#67e8f9',
              fontWeight: '700',
              fontSize: 18,
            }}>{anime.members.toLocaleString()}</Text>
          </View>
          ...
          <View style={{
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
              ...
              <Text style={{ color: '#94a3b8', fontSize: 16, fontWeight: '500' }}>Favorites</Text>
            </View>
            <Text style={{
              color: '#f87171',
              fontWeight: '700',
              fontSize: 18,
            }}>{anime.favorites.toLocaleString()}</Text>
          </View>
          ...
          <View style={{
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
              <Text style={{ fontSize: 20, marginRight: 12 }}>🔥</Text>
              <Text style={{ color: '#94a3b8', fontSize: 16, fontWeight: '500' }}>Popularity Rank</Text>
            </View>
            <Text style={{
              color: '#fbbf24',
              fontWeight: '700',
              fontSize: 18,
            }}>#{anime.popularity}</Text>
          </View>
          ...
          <View style={{
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
              <Text style={{ fontSize: 20, marginRight: 12 }}>⭐</Text>
              <Text style={{ color: '#94a3b8', fontSize: 16, fontWeight: '500' }}>Scored by</Text>
            </View>
            <Text style={{
              color: '#a78bfa',
              fontWeight: '700',
              fontSize: 18,
            }}>{anime.scored_by.toLocaleString()}</Text>
          </View>
          ...
          <View style={{
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
              <Text style={{ fontSize: 20, marginRight: 12 }}>🎯</Text>
              <Text style={{ color: '#94a3b8', fontSize: 16, fontWeight: '500' }}>Rating</Text>
            </View>
            <Text style={{
              color: '#34d399',
              fontWeight: '700',
